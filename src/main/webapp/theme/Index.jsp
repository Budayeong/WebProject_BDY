...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/theme/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="${pageContext.request.contextPath}/theme/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/theme/js/select.dataTables.min.css">
...
<c:if test="${ not empty UserId }">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="images/faces/face28.jpg" alt="profile"/> &nbsp&nbsp
            </a>
             ${ UserId }
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="Board.jsp">자유게시판</a></li>
                <li class="nav-item"> <a class="nav-link" href="QBoard.jsp">Q&A게시판</a></li>
