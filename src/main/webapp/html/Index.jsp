          ...
          <li class="nav-item">
			...
			<!-- 회원정보 start -->
              <c:if test="${ not empty UserId }">
                ...
                <li class="nav-item"> <a class="nav-link" href="../member/modify.do"> 회원정보 </a></li>
			  </c:if>
			  <c:if test="${ empty UserId }">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="${pageContext.request.contextPath}/assets/images/dashboard/people.svg" alt="people">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="${pageContext.request.contextPath}/assets/images/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="${pageContext.request.contextPath}/assets/images/faces/face5.jpg" alt="user">
                        <div>
